...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    switch ($selectedOption) {
        case 'admin':
            header('Location: insert_data_admin.php');
            exit();
        case 'date':
            header('Location: insert_data_date.php');
            exit();
        case 'curieri':
            header('Location: insert_data_curieri.php');
            exit();
...
<body>
    <h1 class="company-name">Insert Data</h1>
    ...
    <div>
        <form action="insert_data.php" method="post">
            ...
            <select id="selection" name="selection" class="dropdown-button">
                ...
                <option value="curieri">Curieri</option>
